...
import com.library.ihttp.api.Api;
import com.library.ihttp.callback.HttpCallback;
import com.library.ihttp.callback.UploadCallback;
import com.library.ihttp.cancel.RequestManagerImpl;
import com.library.ihttp.load.upload.UploadRequestBody;
import com.library.ihttp.observer.HttpObservable;
import com.library.ihttp.retrofit.Method;
import com.library.ihttp.retrofit.RetrofitUtils;
import com.library.ihttp.utils.RequestUtils;
...
public class IHttp {
    ...
    public static final class Configure {
        ...
        /*请求基础路径*/
        public IHttp.Configure baseUrl(String baseUrl) {
        ...
        /*基础参数*/
        public IHttp.Configure baseParameter(Map<String, Object> parameter) {
        ...
        /*基础Header*/
        public IHttp.Configure baseHeader(Map<String, Object> header) {
            this.header = header;
            return this;
        }
        ...
        /*超时时长*/
        public IHttp.Configure timeout(long timeout) {
        ...
        /*是否显示LOG*/
        public IHttp.Configure showLog(boolean showLog) {
        ...
        /*时间单位*/
        public IHttp.Configure timeUnit(TimeUnit timeUnit) {
        ...
        /*初始化全局上下文*/
        public IHttp.Configure init(Application app) {
    ...
    public static final class Builder {
        ...
        /*GET*/
        public IHttp.Builder get() {
            this.method = Method.GET;
            return this;
        }

        /*POST*/
        public IHttp.Builder post() {
            this.method = Method.POST;
            return this;
        }

        /*DELETE*/
        public IHttp.Builder delete() {
            this.method = Method.DELETE;
            return this;
        }

        /*PUT*/
        public IHttp.Builder put() {
            this.method = Method.PUT;
            return this;
        }

        /*基础URL*/
        public IHttp.Builder baseUrl(String baseUrl) {
            this.baseUrl = baseUrl;
            return this;
        }

        /*API URL*/
        public IHttp.Builder apiUrl(String apiUrl) {
            this.apiUrl = apiUrl;
            return this;
        }

        /* 增加 Parameter 不断叠加参数 包括基础参数 */
        public IHttp.Builder addParameter(Map<String, Object> parameter) {
        ...
        public IHttp.Builder setParameter(Map<String, Object> parameter) {
            this.parameter = parameter;
            return this;
        }

        /* 设置String 类型参数  覆盖之前设置  isJson:是否强制JSON格式    bodyString设置后Parameter则无效 */
        public IHttp.Builder setBodyString(String bodyString, boolean isJson) {
            this.isJson = isJson;
        ...
        public IHttp.Builder addHeader(Map<String, Object> header) {
            if (this.header == null) {
        ...
        public IHttp.Builder setHeader(Map<String, Object> header) {
            this.header = header;
            return this;
        }

        /*LifecycleProvider*/
        public IHttp.Builder lifecycle(LifecycleProvider lifecycle) {
            this.lifecycle = lifecycle;
            return this;
        }

        /*ActivityEvent*/
        public IHttp.Builder activityEvent(ActivityEvent activityEvent) {
            this.activityEvent = activityEvent;
            return this;
        }

        /*FragmentEvent*/
        public IHttp.Builder fragmentEvent(FragmentEvent fragmentEvent) {
            this.fragmentEvent = fragmentEvent;
            return this;
        }

        /*tag*/
        public IHttp.Builder tag(String tag) {
            this.tag = tag;
            return this;
        }

        /*文件集合*/
        public IHttp.Builder file(Map<String, File> file) {
            this.fileMap = file;
            return this;
        }

        /*一个Key对应多个文件*/
        public IHttp.Builder file(String key, List<File> fileList) {
            if (fileMap == null) {
        ...
        /*超时时长*/
        public IHttp.Builder timeout(long timeout) {
            this.timeout = timeout;
            return this;
        }

        /*时间单位*/
        public IHttp.Builder timeUnit(TimeUnit timeUnit) {
            this.timeUnit = timeUnit;
            return this;
        }

        public IHttp build() {
            return new IHttp(this);
        }
    }
