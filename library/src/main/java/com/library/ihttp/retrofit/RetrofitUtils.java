package com.library.ihttp.retrofit;

import com.library.ihttp.IHttp;
import com.library.ihttp.cookie.NovateCookieManger;
...
public class RetrofitUtils {
    ...
    public OkHttpClient getOkHttpClient(long timeout, TimeUnit timeUnit, Interceptor... interceptorArray) {
        ...
        //Cookie管理
        okHttpClient.cookieJar(NovateCookieManger.getInstance());
    ...
    public OkHttpClient getOkHttpClientBase(long timeout, TimeUnit timeUnit) {
        ...
        //must
        if(IHttp.Configure.get().isShowLog()){
